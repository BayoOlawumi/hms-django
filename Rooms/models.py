...
class Room(models.Model):
    ...
    creator = models.ForeignKey(UserProfile, null = True, related_name='rooms_created', on_delete=models.PROTECT)
    category= models.ForeignKey(RoomCategory,on_delete=models.CASCADE, null=True, related_name='rooms')
    occupant = models.ForeignKey(Customer, on_delete=models.PROTECT, related_name='rooms', null = True, blank= True)
